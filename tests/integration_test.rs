...
fn test_replicate_estimates_for_a_mean() {
    ...
    assert_eq!(result.final_estimates, dvector![0.03599087180982961, 0.054048403991529756, 0.054505197688378325, 0.04159357573970399, 0.042906564801087246]);
    assert_eq!(result.standard_errors, dvector![0.01107463624697274, 0.009856163557127698, 0.00938364895138013, 0.010089172012288873, 0.011135325191130828]);
}