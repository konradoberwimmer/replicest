...
fn test_replicate_estimates_for_a_correlation() {
    ...
    let result = replication::replicate_estimates(estimates::correlation, &x, &wgt, &repwgt, 1.0);
    ...
    let result_again = replication::replicate_estimates(estimates::correlation, &x, &wgt, &repwgt, 1.0);
